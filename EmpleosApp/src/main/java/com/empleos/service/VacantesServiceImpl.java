...
public class VacantesServiceImpl implements IVacanteService {
    private final List<Vacante> lista;
    ...
    public VacantesServiceImpl() {
        ...
        try {
            ...
            vacante2.setDescripcion("logo importante solicita contador con 5 años de experiencia titulado.");
            ...
            vacante3.setDescripcion("logo internacional solicita Ingeniero mecánico para mantenimiento de la instalación eléctrica.");
            ...
            vacante4.setDescripcion("Solicitamos Diseñador Gráfico titulado para diseñar publicidad de la logo.");
